            ...
            <View style={styles.titleRow}>
              ...
              {onToggleFavorite ? (
                <TouchableOpacity onPress={onToggleFavorite} hitSlop={8} style={styles.favBtn}>
                  <Ionicons name={task.is_favorite ? "heart" : "heart-outline"} size={20} color={task.is_favorite ? colors.black : colors.neutral400} />
                </TouchableOpacity>
              ) : null}
            </View>
            {priceLabel ? <View style={styles.priceRow}><Badge variant="default">{priceLabel}</Badge></View> : null}
          </View>
          {task.description ? (
...
const styles = StyleSheet.create({
  ...
  top: { gap: 6, marginBottom: spacing.sm },
  titleRow: { flexDirection: "row", alignItems: "flex-start", gap: 8 },
  title: { flex: 1, minWidth: 0, fontSize: 16, fontWeight: "700", color: colors.black, lineHeight: 22 },
  favBtn: { paddingHorizontal: 2, paddingVertical: 1 },
  priceRow: { alignSelf: "flex-start" },
